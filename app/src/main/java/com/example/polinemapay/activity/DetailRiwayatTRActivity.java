...
public class DetailRiwayatTRActivity extends AppCompatActivity {
    private static final String TAG = DetailRiwayatTRActivity.class.getSimpleName();
    private ProgressDialog pDialog;

    private TextView idproduk, namapembeli, harga, poin, tgl, waktu;
    RelativeLayout support;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_riwayat_tr);

        idproduk = (TextView) findViewById(R.id.idProduk);
        harga = (TextView) findViewById(R.id.idHarga);
        namapembeli = (TextView) findViewById(R.id.idPembeli);
        ...
        support.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent2 = new Intent(DetailRiwayatTRActivity.this, BantuanAcitivity.class);
    ...
    public void checkRiwayat(final String tanggal, final String waktu) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_DETAILTRANSAKSITUKAR, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String np = user.getString("namaPembeli");
