...
public class FetchDataTaskRiwayatR extends AsyncTask<String, Void, String>{
    private final FetchDataListener listener;
    private String msg;

    public FetchDataTaskRiwayatR(FetchDataListener listener) {
    ...
    protected void onPostExecute(String sJson) {
        ...
        try {
            ...
            // create apps list
            List<ApplicationRiwayatR> apps = new ArrayList<ApplicationRiwayatR>();

            for(int i=0; i<aJson.length(); i++) {
                JSONObject json = aJson.getJSONObject(i);
                ApplicationRiwayatR app = new ApplicationRiwayatR();
                app.setIdAcara(json.getString("idJemput"));
